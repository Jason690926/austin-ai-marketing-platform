...
- ⚠️ 輸出裡要真的有大量換行字元與空白行。
- **必嵌入 4–6 個 emoji，且位置要變化**：句首、句中、句末、甚至單獨成行都可以。⚠️ 不要每個 emoji 都固定貼在行末（那會很「機器套版」），要像真人一樣散落各處。貼合語意（😴 🌙 ❄️ 💧 🛏️ ☀️ 🎁 👇 💗），自然點綴、不堆疊。
...
- **必嵌入 4–6 個 emoji，位置要變化**：句首、句中、句末、單獨成行都可以。⚠️ 不要每個都固定貼行末，要像真人一樣散落各處，貼合語意、不堆疊。
